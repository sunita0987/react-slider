          ...
          >
            {CARD_DATA.map((item, index) => (
              <SwiperSlide>
                <div
                  key={index}
                  className="max-w-[360px] w-full mx-auto relative group transition-all duration-200 ease-linear overflow-hidden"
                >
                  <div className="flex gap-2 rotate-[270.3deg] absolute left-1/2 -translate-x-1/2 z-1 bottom-[250px] xl:bottom-[300px] group-hover:translate-y-[-900px] transition-all duration-200 ease-linear">
                    <p className="font-family-primary whitespace-nowrap text-[#00171F] text-2xl xl:text-[32px] font-normal leading-[110%]">
                      {item.number}
                    </p>
                    <p className="font-family-primary whitespace-nowrap text-[#00171F] text-2xl xl:text-[32px] font-normal leading-[110%]">
                      {item.text}
                  ...
                  <div className="bg-[#003459] p-4 sm:p-8 min-h-[217px] absolute bottom-0 group-hover:translate-y-0 transition-all duration-200 ease-linear translate-y-[105%] ">
                    <div className="flex gap-2 mb-3.5">
                      <h2 className="font-family-primary font-normal text-[24px] xl:text-[28px] 2xl:text-[32px] leading-[110%] capitalize text-white">
                        {item.number}
                      </h2>
                      <h3 className="font-family-primary font-normal text-[24px] xl:text-[28px] 2xl:text-[32px] leading-[110%] capitalize text-white">
                        {item.text}
                      </h3>
                    </div>
                    <p className="font-family-primary text-base leading-[160%] text-white">
                      {item.description}
                    </p>
                  </div>
                </div>
